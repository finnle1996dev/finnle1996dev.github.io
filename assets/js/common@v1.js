...
;(function(window) {
	...
	var defaultSetting = {
		...
		name: "VÃ†Â°Ã†Â¡ng Thanh DiÃ¡Â»â€¡u",
		info: "",
		z_index: 9999,
		blur: ".container",
		lang: "vi-VN",
	...
	WussunTeam.prototype = WussunTeam.fn = {
		...
		init: function(option, undefined) {
			...
			closeBtn.addEventListener("click", function() {
                wussunplay();
				_this.close();
                notyf.success("ÄÃ£ thÃªm chÃºt nháº¡c Ä‘á»¡ nhÃ m chÃ¡n...");
			});
...
document.addEventListener("DOMContentLoaded", function () {
	...
	moon_icon.addEventListener("click", function () {
		...
		if (isDarkThemeEnabled) {
			notyf.success("ÄÃ£ báº­t cháº¿ Ä‘á»™ tá»‘i");
			linkElement.removeAttribute("disabled");
		} else {
			notyf.success("ÄÃ£ báº­t cháº¿ Ä‘á»™ sÃ¡ng");
			linkElement.setAttribute("disabled", "disabled");
		}
